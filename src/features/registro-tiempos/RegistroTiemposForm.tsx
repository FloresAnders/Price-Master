...
type RegistroTiemposFormProps = {
  dateTimeValue: string;
  serverTimeLoading: boolean;
  saldoPaginaTiemposInput: string;
...
export function RegistroTiemposForm({
  dateTimeValue,
  serverTimeLoading,
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[1.15fr_1fr_1fr_1.15fr]">
        ...
        <label>
          <span className={labelClass}>Saldo pagina Tiempos</span>
          <input
            type="text"
            inputMode="decimal"
            value={formatInputDisplay(saldoPaginaTiemposInput)}
            onChange={(event) =>
        ...
        <label>
          <span className={labelClass}>Fondo Tiempos</span>
          <div className="flex gap-2">
            <input
              value={balanceLoading ? "Cargando..." : formatCRC(saldoFondoTiempos)}
              readOnly
            ...
            <button
              ...
              title="Actualizar saldo Fondo Tiempos"
              aria-label="Actualizar saldo Fondo Tiempos"
            >
              <RefreshCw
