...
export const AUTO_ADJUSTMENT_OPENING_TYPE = "AJUSTE APERTURA";
export const APERTURA_FONDO_PROVIDER_CODE = "APERTURA DE FONDO";

export const CIERRE_FONDO_VENTAS_PROVIDER_NAME = "CIERRE FONDO VENTAS";
export const CIERRE_FONDO_VENTAS_MINUTES_BEFORE_END = 15;
export const CIERRE_FONDO_VENTAS_MINUTES_AFTER_END = 45;
export const SINGLE_CLOSING_REASON_PREFIX = "MOTIVO DE UN SOLO CIERRE EN EL DIA: ";
export const SINGLE_CLOSING_REASON_MIN_LENGTH = 10;
