...
import { APERTURA_FONDO_PROVIDER_CODE, AUTO_ADJUSTMENT_OPENING_TYPE } from "../../constants.ts";
import type { FondoEntry } from "../../types.ts";
import type { CashOpeningFormValues } from "../../components/modals/CashOpeningModal.tsx";
import { buildCashOpeningEmailTemplate } from "@/shared/services/email-templates/cash-opening";
