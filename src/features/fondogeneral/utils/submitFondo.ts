...
} from "../../../shared/services/facturas";
import { findLatestMovementByInvoiceNumber, sendDuplicateInvoiceAlertEmail } from "../../../shared/services/duplicate-invoice-alert";
import { MovimientosFondosService, type MovementCurrencyKey } from "../../../shared/services/movimientos-fondos";
import { ProvidersService } from "@/entities/proveedor";
import {
...
import {
  ...
  releaseClosingGuard,
  touchClosingGuard,
} from "./closing/closingGuards.ts";
import {
  getSingleClosingReasonFromNotes,
  hasMinimumSingleClosingReasonLength,
  SINGLE_CLOSING_REASON_OBSERVATIONS_MIN_LENGTH_MESSAGE,
} from "./closing/singleClosingReason.ts";
import { sendMovementNotification } from "./fondo/notifications.ts";
import { validateFondoGeneralOpeningRequirement } from "./fondo/openingRequirement.ts";
