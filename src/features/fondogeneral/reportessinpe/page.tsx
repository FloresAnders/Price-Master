...
import { SchedulesService, type ScheduleEntry } from "@/shared/services/schedules";
...
export default function ReportesSinpePage() {
  ...
  useEffect(() => {
    ...
    getAuthoritativeNow()
      ...
      .catch(() => {
        if (mounted) {
          setError("No se pudo validar la hora del servidor para seleccionar turno automÃ¡tico.");
        }
      });
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#0b1730] p-4">
              ...
              <div className="text-3xl font-semibold">
                â‚¡{summary.total.toLocaleString("es-CR")}
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="mt-4 space-y-3">
                {sortedTransactions.length > 0 ? (
                      ...
                      <div className="grid gap-3 text-sm md:grid-cols-3">
                        <div>
                          ...
                          <div className="mt-1 font-semibold text-emerald-300">
                            â‚¡{transaction.amount.toLocaleString("es-CR")}
                          </div>
                        </div>
                        <div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-[#0b1730] p-4 text-sm text-white/60">
                    No hay correos SINPE vÃ¡lidos en el rango.
                  </div>
                )}
              </div>
            )}
