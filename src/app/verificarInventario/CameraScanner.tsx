...
export default function CameraScanner({
  ...
  return (
    <div>
      ...
      <div
        className={`w-full h-80 bg-[var(--card-bg)] dark:bg-[var(--card-bg)] rounded-3xl overflow-hidden mb-6 relative border-4 border-[var(--input-border)] shadow-2xl flex items-center justify-center transition-opacity duration-200 ${cameraActive ? "opacity-100" : "opacity-30"}`}
      >
        <div ref={liveStreamRef} className="absolute inset-0" />
