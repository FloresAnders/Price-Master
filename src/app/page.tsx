...
type ActiveTab = 'scanner' | 'calculator' | 'converter' | 'xml' | 'cashcounter' | 'timingcontrol' | 'controlhorario' | 'empleados' | 'calculohorasprecios' | 'supplierorders' | 'scanhistory' | 'edit' | 'solicitud' | 'fondogeneral' | 'agregarproveedor' | 'reportes' | 'configuracion' | 'pruebas'
  ...
  useEffect(() => {
    const checkAndSetTab = () => {
      if (typeof window !== 'undefined') {
        ...
        const validTabs = [
          'scanner', 'calculator', 'converter', 'xml', 'cashcounter', 'timingcontrol', 'controlhorario', 'empleados', 'calculohorasprecios', 'supplierorders', 'scanhistory', 'solicitud', 'fondogeneral', 'agregarproveedor', 'reportes', 'configuracion',
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const handleHashChange = () => {
        const hash = window.location.hash.replace('#', '') as ActiveTab;
        const validTabs = [
          'scanner', 'calculator', 'converter', 'xml', 'cashcounter', 'timingcontrol', 'controlhorario', 'empleados', 'calculohorasprecios', 'supplierorders', 'scanhistory', 'edit', 'solicitud', 'fondogeneral', 'agregarproveedor', 'reportes', 'configuracion',
          ...(isSuperAdmin ? ['pruebas'] : [])
        ];
        if (validTabs.includes(hash)) {
          setActiveTab(hash);
