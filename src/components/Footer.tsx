      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <div className="text-center sm:text-left">
            © 2025 Price Master - Herramientas para el manejo de precios
          </div>
          <div className="flex items-center space-x-4">
            <span className="hover:text-gray-700 transition-colors">Next.js 15</span>
            <span className="text-gray-300">•</span>
            <span className="hover:text-gray-700 transition-colors">React 19</span>
            <span className="text-gray-300">•</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li><a href="#" className="hover:text-gray-900 transition-colors">Análisis de Precios</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors">Optimización</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors">Competencia</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors">Reportes</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-gray-900 transition-colors">Equipo</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors">Carreras</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-gray-900 transition-colors">Tutoriales</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-gray-900 transition-colors">Términos de Uso</a></li>
