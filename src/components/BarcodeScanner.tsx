...
export default function BarcodeScanner({ onDetect }: Props) {
  ...
  // ----------------------------------------------------------------------------------
  const detectBasicPatternWithOrientation = useCallback((imageData: ImageData): string | null => {
      // Definir detectBasicPattern dentro del useCallback para evitar dependencias cambiantes
