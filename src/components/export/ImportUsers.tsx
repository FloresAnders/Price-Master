...
export default function ImportUsers() {
    ...
    const handleFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (!confirm(`¿Importar ${dataArray.length} usuarios? ⚠️ Esto puede sobrescribir usuarios existentes.`)) {
                setImporting(false);
                return;
            }
            ...
            for (const item of dataArray) {
                try {
                    ...
                    if (docData.lastLogin && typeof docData.lastLogin === 'string') {
                        docData.lastLogin = new Date(docData.lastLogin);
                    }
