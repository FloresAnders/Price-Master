...
export function RegistroTiemposLoadingState() {
  return (
...
export function RegistroTiemposAccessDeniedState() {
  return (
    <div className="mx-auto max-w-3xl rounded-lg border border-[var(--input-border)] bg-[var(--card-bg)] p-8 text-center">
      ...
      <p className="mt-2 text-[var(--muted-foreground)]">
        No tienes permisos para acceder a Registro Tiempos.
      </p>
    </div>
  );
}

export function RegistroTiemposMissingEmpresaState() {
  return (
    <div className="mx-auto max-w-3xl rounded-lg border border-[var(--input-border)] bg-[var(--card-bg)] p-8 text-center">
      <h2 className="text-xl font-semibold text-[var(--foreground)]">
        Empresa requerida
